...
export class paymentService {
    ...
    private readonly logger = new Logger(paymentService.name); // Create an instance of the Logger
    ...
    async receiveMoney(amount: number,userId:number) {
      ...
      async sendMoney(amount: number,userId:number) {
      ...
      if(!freeLance){
        ...
        throw new NotFoundException("fnot fouund");
      }
