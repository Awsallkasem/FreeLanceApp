...
export declare class PayAndRecive extends Model<PayAndRecive> {
    id: number;
    amount: number;
    date: Date;
    isByPoint: boolean;
    ...
    freeLanceId: number;
    freeLance: FreeLance;
    static statisticalsyear(year: number, freeLanceId: number): Promise<any[]>;
    static statisticalsCategoryweekly(year: number): Promise<any[]>;
    static statisticalsCategory(): Promise<any[]>;
}
