...
exports.PayAndRecive = exports.FreelanceCategory = void 0;
...
let PayAndRecive = class PayAndRecive extends sequelize_typescript_1.Model {
    static async statisticalsyear(year, freeLanceId) {
    ...
    static async statisticalsCategoryweekly(year) {
        return await this.findAll({
            attributes: [
                [this.sequelize.fn('YEARWEEK', this.sequelize.col('date'), 0), 'week'],
    ...
    static async statisticalsCategory() {
        return await this.findAll({
            attributes: [
                [this.sequelize.col('category'), 'category'],
                [this.sequelize.fn('COUNT', this.sequelize.col('category')), 'categoryCount']
...
], PayAndRecive.prototype, "category", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => user_model_1.User),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, allowNull: false }),
    (0, class_validator_1.IsNotEmpty)({ message: 'userId is required' }),
    __metadata("design:type", Number)
], PayAndRecive.prototype, "userId", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => user_model_1.User),
    __metadata("design:type", user_model_1.User)
], PayAndRecive.prototype, "user", void 0);
__decorate([
    (0, sequelize_typescript_1.ForeignKey)(() => freeLance_model_1.FreeLance),
    (0, sequelize_typescript_1.Column)({ type: sequelize_typescript_1.DataType.INTEGER, allowNull: false }),
    (0, class_validator_1.IsNotEmpty)({ message: 'userId is required' }),
    __metadata("design:type", Number)
], PayAndRecive.prototype, "freeLanceId", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsTo)(() => user_model_1.User),
    __metadata("design:type", freeLance_model_1.FreeLance)
], PayAndRecive.prototype, "freeLance", void 0);
PayAndRecive = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'payAndRecive' })
], PayAndRecive);
exports.PayAndRecive = PayAndRecive;
//# sourceMappingURL=payAndRecive.model.js.map